...
abstract class RemoteViewsAction extends Action<RemoteViewsAction.RemoteViewsTarget> {
    ...
    static class AppWidgetAction extends RemoteViewsAction {
        ...
        AppWidgetAction(Picasso picasso, Request data, Target<RemoteViewsTarget> wrapper, int[] appWidgetIds, Callback callback) {
    ...
    static class NotificationAction extends RemoteViewsAction {
        ...
        NotificationAction(Picasso picasso, Request data, Target<RemoteViewsTarget> wrapper, int notificationId, Notification notification, String notificationTag, Callback callback) {
            super(picasso, data, wrapper, callback);
