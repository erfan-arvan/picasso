...
public class RequestCreator {
     ...
     */
    public void into(RemoteViews remoteViews, @IdRes int viewId, int notificationId, Notification notification) {
     ...
     * given {@code viewId}. This is used for loading bitmaps into a {@link Notification}.
     */
    public void into(RemoteViews remoteViews, @IdRes int viewId, int notificationId, Notification notification, String notificationTag) {
